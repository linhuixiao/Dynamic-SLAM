...
int main(int argc, char **argv)
{
    if(argc < 6)
    {
        cerr << endl << "Usage: ./mono_kitti path_to_vocabulary path_to_settings path_to_sequence model_file weights_file" << endl;
        return 1;
    }
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        //when tracking is hard, start the following usleep
        usleep(100000);
